      ...
      <div class="container box ">
        <div class="" id="customer-order">
          <a type="button" class="" data-toggle="modal" data-target="#modal-fotos">
            ...
            <?php  
              if($consulta == 'erro'){
                $arrobaFan = $arrobaCriador['usuMarca'];
                cadastroAdm($criadorPagina, $idPagina, $arrobaFan);
                echo '<img src="imagem/sistema/loading.gif" class="img-responsive" ><p>Primeiro acesso, estamos configurado seu blog.</p>';
                header("Refresh:5");
                exit;
              }
            ?>
