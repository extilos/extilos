...
if(!empty($_POST["keyword"])) {
	...
	<?php while ($user = $categoria->fetch(PDO::FETCH_ASSOC)): //prepara o conteúdo para ser listado ?>
			...
			<img src="../imagem/sistema/<?php echo $user['torreImg'] ?>">
				<p><b><?php echo (palavraCurta(20,$nomeTorre)); ?></b></p>
				<?php if($tipoTorre > 0) { //se é 0 a torre é publica, se 1 é privada ?>
					<small>
					<i class="fa fa-map-marker"></i> <?php echo (palavraCurta(20,$cidadeTorre)); echo "-".$estadoTorre; ?> | 
