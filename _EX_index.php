...
//carrega informações fundamentais
...
include_once 'functions/functions.php';
include_once 'functions/postagem_foto.php';
...
<body>
            ...
            <div id="advantages">
                ...
                <div class="container">
                    <div class="same-height-row">
                        ...
                        <div class=" box same-height clickable text-center  col-sm-4">
                            <h3><a href="#">baixe o app</a></h3>
 ...
 _________________________________________________________ -->
            <div id="hot">
                ...
                <?php postagens($idUsuario,$tokenDia,$idTorre,$idPagina,$qtdSolicitada,$qtdExibida) ?>
                <!-- /.container -->
 ...
 _________________________________________________________ -->
    ...
    <?php tempoPagina_fim($pagina,$idUsuario,$executionStartTime); ?>
