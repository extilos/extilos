                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                           <img src="imagem/capa/media/album.jpg" alt="<?php echo $user['nomePagina']; ?>">
                                        </td>
                                            <?php
                            ...
                            <?php if($total==0){ ?>
                                <p>Você ainda não tem participação em algum blog</p>
                                <div class="col-sm-12 text-center torre">
                                    <input onclick="Nova()" class="btn btn-sm btn-block btn-primary" value="Cadastrar Novo Blog">
                                  </div>
                            <?php }?>
                        </div>
                    </div>
