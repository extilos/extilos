...
?>
  ...
  if ($resposta == 'alb_nome_negado' ){ ?>
    ...
    if ($resposta == 'alb_erro_cTorre' ){ ?>
      <div class="alert">
        <button type="button" class="close" data-dismiss="alert">×</button>
          <p class="text-muted" ><b><font color="d60808">Ops!</b> Ocorreu algum erro na publicação deste album na Torre, tente novamente. Caso persista o erro, abra um chamado no suporte informando este código: <b>HAS#102</b></font></p>
      </div>
    <?php ;
    unset($_SESSION['resposta']);}
    ?>
    <?php
    // RESPOSTA DE ERRO NO CADASTRO DE HASTAG NO BANCO DE DADOS
    if ($resposta == 'alb_erro_cPagina' ){ ?>
      <div class="alert">
        <button type="button" class="close" data-dismiss="alert">×</button>
          <p class="text-muted" ><b><font color="d60808">Ops!</b> Ocorreu algum erro na publicação deste album no Blog, tente novamente. Caso persista o erro, abra um chamado no suporte informando este código: <b>HAS#102</b></font></p>
      </div>
    <?php ;
    unset($_SESSION['resposta']);}
    ?>
