<?php
function postagens($idUsuario,$tokenDia,$idBusca,$tipoBusca,$qtdSolicita,$qtdExibida){
?>
<div class="container">
    <?php 
    //$idUsuario = 2;
    ...
    $busca_post = buscar_post($idBusca, $tipoBusca, 0, $fim);
        ...
        if($registro->postagem > ''){
            ...
            <div class="box slideshow col-sm-3">
                <div class="col-sm-9 col-xs-9 text-left">
                    <p>Por:
                        <a href="pagina/<?php echo $nomeBlog?>" target="_blank"><?php echo '<i class="fa fa-user"></i>|'.$nomeBlog.$idPostagem ?></a></p>
                    </div>
                    <?php if($idUsuario > 1){ ?>
                    ...
                    <div class="col-sm-12 ">
                        ...
                        <p class="buttons">
                            ...
                            pontos('FAVORITOS','<?php echo $registro->postagem ?>','<?php echo $idUsuario ?>','<?php echo $tokenDia ?>','<?php echo $idTorre ?>')" 
                            ...
                            onclick="
                                ...
                                pontos('VISITAS','<?php echo $registro->postagem ?>','<?php echo $idUsuario ?>','<?php echo $tokenDia ?>','<?php echo $idTorre ?>')"
                            data-toggle="modal"
                            ...
                            <a class="<?php echo $bloqueioNegativo ?>"
                                ...
                                pontos('CURTIDA','<?php echo $registro->postagem ?>','<?php echo $idUsuario ?>','<?php echo $tokenDia ?>','<?php echo $idTorre ?>','luis')"
                              ...
                              <div class="modal-header">
                                ...
                                <div class="text-center">
                                    ...
                                    <a class="<?php echo $bloqueioNegativo ?>"
                                        ...
                                        curtir('<?php echo $registro->postagem?>','<?php echo $idUsuario ?>','<?php echo $tokenDia ?>', '<?php echo $idTorre ?>','<?php echo $idPagina ?>' );
                                        pontos('CURTIDA','<?php echo $registro->postagem ?>','<?php echo $idUsuario ?>','<?php echo $tokenDia ?>','<?php echo $idTorre ?>')"
