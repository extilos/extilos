...
<head> 
    ...
    <!-- styles -->
    <link href="/extilos/css/font-awesome.css" rel="stylesheet">
    <link href="/extilos/css/bootstrap.min.css" rel="stylesheet">
    <link href="/extilos/css/animate.min.css" rel="stylesheet">
    <link href="/extilos/css/owl.carousel.css" rel="stylesheet">
    <link href="/extilos/css/owl.theme.css" rel="stylesheet">
    <!-- theme stylesheet -->
    <link href=<?php echo $corBotao ?> rel="stylesheet" id="theme-stylesheet">
    <!-- your stylesheet with modifications -->
    <link href="/extilos/css/custom.css" rel="stylesheet">
    <script src="/extilos/js/respond.min.js"></script>
...
<body>
    ...
    <script src="/extilos/js/jquery-1.11.0.min.js"></script>
    <script src="/extilos/js/bootstrap.min.js"></script>
    <script src="/extilos/js/jquery.cookie.js"></script>
    <script src="/extilos/js/waypoints.min.js"></script>
    <script src="/extilos/js/modernizr.js"></script>
    <script src="/extilos/js/bootstrap-hover-dropdown.js"></script>
    <script src="/extilos/js/owl.carousel.min.js"></script>
    <script src="/extilos/js/front.js"></script>
</body>
</html>
